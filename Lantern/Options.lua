...
local CORE_KEY = {
    ...
    ConsumableAlerts     = "consumableAlerts",
...
local MODULE_CATEGORIES = {
    ...
    },
    {
        ...
        modules = {
            ...
            "CombatAlert", "CombatTimer", "ConsumableAlerts", "FocusCastBar", "GatewayReady", "MissingPet", "RangeCheck", "ReleaseProtection", "SummonHelper",
        },
        combinedPages = {
            {
