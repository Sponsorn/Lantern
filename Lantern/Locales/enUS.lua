...
Lantern:RegisterLocale("enUS", {

    -- Shared
    ENABLE                                  = "Enable",
    MODULE_ENABLE_DESC                      = "Enable or disable %s.",
    SHARED_FONT                             = "Font",
    ...
    -- Summon Helper (includes Outside Roster)
    RAIDROSTER_HEADER                       = "Needs summon",
    RAIDROSTER_TITLE                        = "Outside Roster",
    RAIDROSTER_DESC                         = "Show a frame listing raid members not in your zone.",
    RAIDROSTER_PORTAL_UP                    = "Portal up! Click to summon",
    SUMMONHELPER_TITLE                      = "Summon Helper",
    SUMMONHELPER_DESC                       = "Shows chat messages when a summoning portal is placed and when players are being summoned.",
    SUMMONHELPER_ENABLE_DESC                = "Enable summon tracking notifications.",
    SUMMONHELPER_PORTAL_PLACED              = "%s placed a summoning portal, please click!",
    SUMMONHELPER_SUMMONING                  = "Summoning %s, please click!",
    SUMMONHELPER_ACCEPTED                   = "%s accepted the summon.",
    SUMMONHELPER_DECLINED                   = "%s declined the summon.",
    SUMMONHELPER_SHOW_PORTAL                = "Portal Placed",
    SUMMONHELPER_SHOW_PORTAL_DESC           = "Show a message when a warlock places a summoning portal.",
    SUMMONHELPER_SHOW_SUMMON                = "Summon Started",
    SUMMONHELPER_SHOW_SUMMON_DESC           = "Show a message when a player starts being summoned.",
    SUMMONHELPER_ANNOUNCE_SAY                = "Announce in /say",
    SUMMONHELPER_ANNOUNCE_SAY_DESC           = "Send a /say message when you start summoning a player.",
    SUMMONHELPER_GROUP_CHAT                 = "Notifications",
    SUMMONHELPER_GROUP_NOTIF_TEXT            = "Notification Text",
    SUMMONHELPER_GROUP_NOTIF_STYLE           = "Notification Style",
    SUMMONHELPER_GROUP_NOTIF_POSITION        = "Notification Position",
    SUMMONHELPER_PORTAL_PLACED_TEXT          = "Portal Placed Text",
    SUMMONHELPER_PORTAL_PLACED_TEXT_DESC     = "Message when a portal is placed. Use %s for the caster name.",
    SUMMONHELPER_SUMMONING_TEXT              = "Summoning Text",
    SUMMONHELPER_SUMMONING_TEXT_DESC         = "Message when a player is being summoned. Use %s for the player name.",
    SUMMONHELPER_ACCEPTED_TEXT               = "Accepted Text",
    SUMMONHELPER_ACCEPTED_TEXT_DESC          = "Message when a player accepts a summon. Use %s for the player name.",
    SUMMONHELPER_DECLINED_TEXT               = "Declined Text",
    SUMMONHELPER_DECLINED_TEXT_DESC          = "Message when a player declines a summon. Use %s for the player name.",
    SUMMONHELPER_NOTIF_DURATION              = "Duration",
    ...
    GATEWAYREADY_TEXT                       = "GATEWAY READY",
    GATEWAYREADY_ENABLE_DESC                = "Show an alert when a Demonic Gateway is usable.",
    GATEWAYREADY_COMBAT_ONLY                = "Combat Only",
    GATEWAYREADY_COMBAT_ONLY_DESC           = "Only check for gateways during combat.",
    ...
    -- Focus Cast Bar
    FOCUSCASTBAR_TITLE                      = "Focus Cast Bar",
    FOCUSCASTBAR_DESC                       = "Shows a cast bar for your focus target with interrupt tracking.",
    FOCUSCASTBAR_ENABLE_DESC                = "Enable or disable the Focus Cast Bar.",
    FOCUSCASTBAR_GROUP_APPEARANCE           = "Appearance",
    FOCUSCASTBAR_BAR_WIDTH                  = "Bar Width",
    FOCUSCASTBAR_BAR_WIDTH_DESC             = "Width of the cast bar.",
    FOCUSCASTBAR_BAR_HEIGHT                 = "Bar Height",
    FOCUSCASTBAR_BAR_HEIGHT_DESC            = "Height of the cast bar.",
    FOCUSCASTBAR_BAR_READY_COLOR            = "Bar Color (Ready)",
    FOCUSCASTBAR_BAR_READY_COLOR_DESC       = "Bar color when your interrupt is off cooldown.",
    FOCUSCASTBAR_BAR_CD_COLOR               = "Bar Color (On CD)",
    FOCUSCASTBAR_BAR_CD_COLOR_DESC          = "Bar color when your interrupt is on cooldown.",
    FOCUSCASTBAR_NONINT_COLOR               = "Non-Interruptible Color",
    FOCUSCASTBAR_NONINT_COLOR_DESC          = "Overlay color for non-interruptible casts.",
    FOCUSCASTBAR_HIGHLIGHT_IMPORTANT        = "Highlight Important Casts",
    FOCUSCASTBAR_HIGHLIGHT_IMPORTANT_DESC   = "Use a distinct color for casts Blizzard marks as important (e.g. lethal if not interrupted).",
    FOCUSCASTBAR_IMPORTANT_COLOR            = "Important Cast Color",
    FOCUSCASTBAR_IMPORTANT_COLOR_DESC       = "Bar color for important casts.",
    FOCUSCASTBAR_BG_COLOR                   = "Background Color",
    ...
    FOCUSCASTBAR_ICON_SIZE                  = "Icon Size",
    FOCUSCASTBAR_ICON_SIZE_DESC             = "Size of the spell icon.",
    FOCUSCASTBAR_ICON_POSITION              = "Icon Position",
    FOCUSCASTBAR_ICON_POSITION_DESC         = "Where to place the spell icon relative to the bar.",
    FOCUSCASTBAR_GROUP_TEXT                  = "Text",
    FOCUSCASTBAR_SHOW_SPELL_NAME            = "Show Spell Name",
    FOCUSCASTBAR_SHOW_SPELL_NAME_DESC       = "Display the name of the spell being cast.",
    FOCUSCASTBAR_SHOW_TIME                  = "Show Time Remaining",
    FOCUSCASTBAR_SHOW_TIME_DESC             = "Display the remaining cast time.",
    FOCUSCASTBAR_TEXT_COLOR                  = "Text Color",
    FOCUSCASTBAR_TEXT_COLOR_DESC             = "Color of the spell name and time text.",
    FOCUSCASTBAR_GROUP_BEHAVIOR             = "Behavior",
    FOCUSCASTBAR_SHOW_EMPOWER               = "Show Empower Stages",
    FOCUSCASTBAR_SHOW_EMPOWER_DESC          = "Show stage markers for empowered channels.",
    FOCUSCASTBAR_HIDE_FRIENDLY              = "Hide Friendly Casts",
    FOCUSCASTBAR_HIDE_FRIENDLY_DESC         = "Hide the bar when your focus target is a friendly unit.",
    FOCUSCASTBAR_SHOW_SHIELD                = "Show Shield Icon",
    FOCUSCASTBAR_SHOW_SHIELD_DESC           = "Show a shield icon below the bar for non-interruptible casts.",
    FOCUSCASTBAR_COLOR_NONINT               = "Color Non-Interruptible",
    FOCUSCASTBAR_COLOR_NONINT_DESC          = "Apply the non-interruptible color overlay on shielded casts.",
    FOCUSCASTBAR_HIDE_ON_CD                 = "Hide When Kick On CD",
    FOCUSCASTBAR_HIDE_ON_CD_DESC            = "Hide the bar entirely when your interrupt is on cooldown.",
    FOCUSCASTBAR_SHOW_TICK                  = "Show Interrupt Tick",
