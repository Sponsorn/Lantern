...
Lantern:RegisterLocale("esES", {
    ...
    MINIMAP_CLICKS_HEADER                   = "Acciones del boton del minimapa",
    MINIMAP_CLICK_LEFT                      = "Clic izquierdo",
    MINIMAP_CLICK_SHIFT_LEFT                = "Shift + Clic izquierdo",
    MINIMAP_CLICK_CTRL_LEFT                 = "Ctrl + Clic izquierdo",
    MINIMAP_CLICK_RIGHT                     = "Clic derecho",
    MINIMAP_CLICK_SHIFT_RIGHT               = "Shift + Clic derecho",
    MINIMAP_CLICK_CTRL_RIGHT                = "Ctrl + Clic derecho",
    MINIMAP_ACTION_SETTINGS                 = "Ajustes de Lantern",
    MINIMAP_ACTION_CRAFTING                 = "Pedidos de fabricacion",
    MINIMAP_ACTION_WARBAND                  = "Warband",
    MINIMAP_ACTION_SPELLBOOK                = "Libro de hechizos",
    MINIMAP_ACTION_TALENTS                  = "Talentos",
    MINIMAP_ACTION_COLLECTIONS              = "Colecciones",
    MINIMAP_ACTION_GROUP_FINDER             = "Buscador de grupo",
    MINIMAP_ACTION_COMMUNITIES              = "Hermandad / Comunidades",
    MINIMAP_ACTION_WORLD_MAP                = "Mapa del mundo",
    MINIMAP_ACTION_ACHIEVEMENTS             = "Logros",
    MINIMAP_ACTION_CALENDAR                 = "Calendario",
    MINIMAP_ACTION_EDIT_MODE                = "Modo de edicion",
    MINIMAP_ACTION_RELOAD                   = "Recargar IU",
    MINIMAP_ACTION_SLASH                    = "Comando de barra",
    MINIMAP_ACTION_NONE                     = "Nada",
    MINIMAP_SLASH_PLACEHOLDER               = "ej. /reload",
    MINIMAP_NO_SETTINGS_HINT                = "Siempre puedes abrir los ajustes de Lantern escribiendo /lantern",
