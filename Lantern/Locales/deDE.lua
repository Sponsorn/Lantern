...
Lantern:RegisterLocale("deDE", {
    ...
    MINIMAP_CLICKS_HEADER                   = "Minimap-Schaltflaechen-Aktionen",
    MINIMAP_CLICK_LEFT                      = "Linksklick",
    MINIMAP_CLICK_SHIFT_LEFT                = "Shift + Linksklick",
    MINIMAP_CLICK_CTRL_LEFT                 = "Ctrl + Linksklick",
    MINIMAP_CLICK_RIGHT                     = "Rechtsklick",
    MINIMAP_CLICK_SHIFT_RIGHT               = "Shift + Rechtsklick",
    MINIMAP_CLICK_CTRL_RIGHT                = "Ctrl + Rechtsklick",
    MINIMAP_ACTION_SETTINGS                 = "Lantern Einstellungen",
    MINIMAP_ACTION_CRAFTING                 = "Fertigungsauftraege",
    MINIMAP_ACTION_WARBAND                  = "Warband",
    MINIMAP_ACTION_SPELLBOOK                = "Zauberbuch",
    MINIMAP_ACTION_TALENTS                  = "Talente",
    MINIMAP_ACTION_COLLECTIONS              = "Sammlungen",
    MINIMAP_ACTION_GROUP_FINDER             = "Gruppensuche",
    MINIMAP_ACTION_COMMUNITIES              = "Gilde / Gemeinschaften",
    MINIMAP_ACTION_WORLD_MAP                = "Weltkarte",
    MINIMAP_ACTION_ACHIEVEMENTS             = "Erfolge",
    MINIMAP_ACTION_CALENDAR                 = "Kalender",
    MINIMAP_ACTION_EDIT_MODE                = "Bearbeitungsmodus",
    MINIMAP_ACTION_RELOAD                   = "UI neu laden",
    MINIMAP_ACTION_SLASH                    = "Slash-Befehl",
    MINIMAP_ACTION_NONE                     = "Nichts",
    MINIMAP_SLASH_PLACEHOLDER               = "z.B. /reload",
    MINIMAP_NO_SETTINGS_HINT                = "Du kannst die Lantern Einstellungen jederzeit mit /lantern oeffnen",
