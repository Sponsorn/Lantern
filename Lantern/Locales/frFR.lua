...
Lantern:RegisterLocale("frFR", {
    ...
    SHARED_SHOW_CHAT_MESSAGE                = "Afficher un message dans le chat",
    ...
    GENERAL_AUTO_ENABLE_NEW                 = "Activer automatiquement les nouvelles fonctionnalites",
    GENERAL_AUTO_ENABLE_NEW_DESC            = "Activer automatiquement les modules nouvellement ajoutes. Si desactive, les nouveaux modules demarrent desactives et doivent etre actives manuellement.",
    ...
    MINIMAP_CLICKS_HEADER                   = "Actions du bouton de minicarte",
    MINIMAP_CLICK_LEFT                      = "Clic gauche",
    MINIMAP_CLICK_SHIFT_LEFT                = "Shift + Clic gauche",
    MINIMAP_CLICK_CTRL_LEFT                 = "Ctrl + Clic gauche",
    MINIMAP_CLICK_RIGHT                     = "Clic droit",
    ...
    MINIMAP_ACTION_GROUP_FINDER             = "Recherche de groupe",
    MINIMAP_ACTION_COMMUNITIES              = "Guilde / Communautes",
    MINIMAP_ACTION_WORLD_MAP                = "Carte du monde",
    MINIMAP_ACTION_ACHIEVEMENTS             = "Hauts faits",
    MINIMAP_ACTION_CALENDAR                 = "Calendrier",
    MINIMAP_ACTION_EDIT_MODE                = "Mode d'edition",
    MINIMAP_ACTION_RELOAD                   = "Recharger l'IU",
    MINIMAP_ACTION_SLASH                    = "Commande slash",
    MINIMAP_ACTION_NONE                     = "Rien",
    MINIMAP_SLASH_PLACEHOLDER               = "ex. /reload",
    MINIMAP_NO_SETTINGS_HINT                = "Vous pouvez toujours ouvrir les parametres Lantern en tapant /lantern",
    ...
    AUTOQUEUE_AUTO_ACCEPT_INVITE            = "Accepter automatiquement les invitations de groupe",
    AUTOQUEUE_AUTO_ACCEPT_INVITE_DESC       = "Accepter automatiquement les invitations du Recherche de Groupe lorsque votre candidature est acceptee.",
    AUTOQUEUE_ONE_CLICK_SIGNUP              = "Inscription en un clic",
    AUTOQUEUE_ONE_CLICK_SIGNUP_DESC         = "Passer le dialogue de role/note lors de la candidature aux groupes.",
    AUTOQUEUE_ANNOUNCE_DESC                 = "Afficher un message dans le chat lorsqu'une action automatique est effectuee.",
    ...
    AUTOREPAIR_SHOW_MESSAGE_DESC            = "Afficher un message dans le chat lorsque l'equipement est repare automatiquement.",
    ...
    SPLASH_CREDITS_HEADER                   = "Remerciements",
    SPLASH_CREDITS                          = "Remerciements particuliers a @imhavingfun pour les tests et les rapports de bugs.",
    COPY                                    = "Copier",
    SELECT                                  = "Selectionner",
    ...
    AUTOQUEUE_MSG_INVITE_ACCEPTED           = "Invitation de groupe auto-acceptee.",
    AUTOQUEUE_MSG_SIGNUP_SKIPPED            = "Candidature au groupe envoyee automatiquement.",
    ...
    -- Flight Path Line
    MAPLINE_TITLE                           = "Ligne de trajet de vol",
    MAPLINE_DESC                            = "Dessine une ligne directionnelle sur la carte du monde pendant le vol.",
    MAPLINE_ENABLE_DESC                     = "Afficher une ligne pointillee sur la carte du monde indiquant votre direction de vol.",
    MAPLINE_STYLE                           = "Style de ligne",
    MAPLINE_STYLE_DESC                      = "Comment la ligne directionnelle apparait sur la carte.",
    MAPLINE_STYLE_SOLID                     = "Continue",
    MAPLINE_STYLE_DOTTED                    = "Pointillee",
    MAPLINE_STYLE_THICK                     = "Epaisse",
    MAPLINE_COLOR                           = "Couleur de ligne",
    MAPLINE_COLOR_DESC                      = "Couleur et opacite de la ligne directionnelle.",
    MAPLINE_LENGTH                          = "Longueur de ligne",
    MAPLINE_LENGTH_DESC                     = "Distance a laquelle la ligne directionnelle s'etend depuis votre position.",

    -- Skip Cinematics
    SKIPCINEMATICS_TITLE                    = "Ignorer les cinematiques",
    SKIPCINEMATICS_DESC                     = "Ignorer automatiquement les films, cinematiques et scenes.",
    SKIPCINEMATICS_ENABLE_DESC              = "Ignorer automatiquement les films, cinematiques et scenes du jeu. Maintenez %s pour regarder.",
    SKIPCINEMATICS_SKIPPED                  = "Cinematique ignoree.",
    SKIPCINEMATICS_SHOW_MESSAGE_DESC        = "Afficher un message dans le chat lorsqu'une cinematique est ignoree.",
});
